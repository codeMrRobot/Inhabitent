...
<div class="widget-content">
   ...
   <p><label for="<?php echo $this->get_field_id('monday_friday'); ?>">Monday To Friday Hours:</label>
   ...
   <p><label for="<?php echo $this->get_field_id('saturday'); ?>">Saturday Hours:</label>
   ...
   <p><label for="<?php echo $this->get_field_id('sunday'); ?>">Sunday hours:</label>
